...
describe('CategoryService', () => {
  ...
  describe('create', () => {
    it('should create a new category', async () => {
      ...
      expect(result).toEqual({ message: 'Category created!', newCategory: createdCategory });
    });
    ...
    it('should throw error if category already exists', async () => {
      ...
      await expect(service.create(createCategoryDto)).rejects.toThrowError('Category already exists!');
    });
  });
  ...
  describe('findAll', () => {
    ...
    it('should throw error if no categories found', async () => {
      ...
      await expect(service.findAll()).rejects.toThrowError('No categories found!');
    });
  });
});
